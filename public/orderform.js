...
// Minor changes to this function only to format the request data differently
function submitOrder(){
	...
	info.order = order;
	// Used another object to nest the order inside to add a username and _id property
	let generalInfo = {}
	generalInfo.username = theUsername;
	generalInfo.order = info;
	...
	req.send(JSON.stringify(generalInfo));
}
...
function init(){
	...
	document.getElementById("restaurant-select").onchange = function(){selectRestaurant()};
	selectRestaurant();
